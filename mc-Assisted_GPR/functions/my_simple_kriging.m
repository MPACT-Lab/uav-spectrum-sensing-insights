function [est_tar, est_variance, num_points] = my_simple_kriging(meas_correlation_all,...
    target_cross_correlation_all, index_valid_radi, meas_sha, var_sha, mu_sha)
    ...
    for tar_idx = 1 : num_test_points
        ...
        if num_meas_valid > 0
            ...
            est_tar(tar_idx, 1) = real(lammda')*(meas_sha_activated - mu_sha) + mu_sha ;
