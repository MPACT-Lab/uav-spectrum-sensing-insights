...
save(sprintf("profiles/normal_transformation_ant"+exp_name+".mat"), 'trans_gauss', 'trans_raw', 'second_der_value')
...
save(sprintf("profiles/correlation_table_3D_gauss_a2g"+is_smooth+exp_name+".mat"),'hor_dist_list','ver_dist_list', 'corr_list', 'mu_sha', "var_sha", 'd_int', 'h_int', 'correlation_f')
%% 
