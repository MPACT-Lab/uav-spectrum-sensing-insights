...
all_heights = [110]; % change it {30, 50, 70, 90, 110}
...
save(sprintf("profiles/correlation_table_3D"+exp_name+".mat"),'hor_dist_list','ver_dist_list', 'corr_list', 'mu_sha', "var_sha", 'd_int', 'h_int', 'correlation_f')
%% 
