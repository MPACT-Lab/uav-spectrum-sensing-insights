...
clear;
close all;
% pre requisite threed_corr_gen_ok_sk.m (without normal transformation)
addpath('functions\')
...
for repeat_id = 1:num_repeat
    ...
    for height_id = 1:length(all_heights)
        ...
        load(sprintf("../corr_prof/profiles/correlation_table_3D_%dm.mat",all_heights_train(height_id))) % 'hor_dist_list','ver_dist_list', 'corr_list', 'mu_sha', "var_sha", 'd_int', 'h_int', 'correlation_f'
...
%% 
%save results/res_kriging_ordinary_sung_joon_50_250_3_5k.mat error_all_2d num_meas_used_2d lat_calc lon_calc h_calc radius_all num_known_samples variance_all_2d all_heights threed