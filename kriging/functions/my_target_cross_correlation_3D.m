function target_xcorr_all = my_target_cross_correlation_3D(lat_meas,lon_meas, h_meas, lat_tar, lon_tar, h_tar, corr_coef, var_sha)
    ...
    for i=1:num_tar
        for j=1:num_meas
            dist_ver_ij = abs(h_tar(i) - h_meas(j));
