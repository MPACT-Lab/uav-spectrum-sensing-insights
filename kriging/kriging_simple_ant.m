    ...
    for height_id = 1:length(all_heights)
        ...
        for meas_i = 1:length(num_known_samples)
            ...
            for radi_i = 1:length(radius_all)
               ...
               [est_tar, est_variance, num_points] = my_simple_kriging(meas_correlation_all,...
...
%% 
save results/res_kriging_simple_sung_joon_50_250_2_a2g_5k.mat error_all_2d num_meas_used_2d lat_calc lon_calc h_calc radius_all num_known_samples variance_all_2d all_heights threed
