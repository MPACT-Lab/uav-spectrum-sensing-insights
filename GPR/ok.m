    ...
    for repeat_id = 1:num_repeat
        ...
        for meas_i = 1:length(num_known_samples)
            ...
            for radi_i = 1:length(radius_all)
               ...
               [est_tar, num_points] = my_oridinary_kriging(meas_correlation_all,...
...
%% 
save results\res_ok_lte_70m.mat error_all_2d num_meas_used_2d lat_calc lon_calc h_calc radius_all num_known_samples all_heights threed